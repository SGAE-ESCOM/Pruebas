...
class Registrar_Preguntas:
    ...
    def registrar_preguntas(self):
       ...
       #Boton ir a preguntas
        ...
        #time.sleep(2)
        b = self.driver.find_element_by_id('txtBuscar')
        b.send_keys("Reacciones Químicas")
        time.sleep(2)
        ...
        #Boton Agregar
        self.driver.find_element_by_name('agregarPregunta').click()
        time.sleep(2)
        ...
        for i in range(0,len(datos)):
            ...
            time.sleep(1)
            btn_agregar_lista = self.driver.find_element_by_name('agregarItem')
            inp[i].send_keys(datos[i])
            time.sleep(2)
            #Agregar  respuesta con Imagenes
        ...
        time.sleep(2)
        opc_per = self.driver.find_elements_by_class_name('mat-option')[1]
        opc_per.click()
        time.sleep(2)
        self.driver.find_element_by_name('btnModalAgregar').click()
        time.sleep(10)

        print("... Test Case 'Registrar Preguntas' Successful ...")
        print("==============================================")
